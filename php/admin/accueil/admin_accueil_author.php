...
if(!empty($bdd)){
    ...
    if (!empty($authors)){
        foreach ($authors as $author){
            ...
            echo "L'auteur numéro " . $author->id_auteur . " s'appelle " . '<a href ="../gestion_auteur/infos_auteur.php?id_auteur=' .$author->id_auteur .'">' . $author->prenom_auteur . ' ' . $author->nom_auteur . '</a>' .
            ...
            echo '<a href="../gestion_auteur/modifier_auteur.php?id_auteur=' . $author->id_auteur .'">Modifier</a>' . ' ou ' .
                '<a href="../gestion_auteur/supprimer_auteur.php?id_auteur=' . $author->id_auteur .'">Supprimer</a>' .' cet auteur' . '<br>';
