...
<div class="centered_alone">
    ...
    if (isAdmin($id_client) == true) {
        ...
        if ($client->amende == null){
            echo "Son amende est de : 0€ <br><br>";
        } else {
        ...
        foreach ($reservations AS $reservation) {
            echo "<p>" . "<a href='../gestion_reservations/modifier_reservation.php?idReserv= " . $reservation->idReserv . "'> " .$reservation->idReserv . "</a> - " . $reservation->nom_livre . " - " . $reservation->prenom_auteur . " " . $reservation->nom_auteur . " du " . $reservation->dateDebut . " au " . $reservation->dateFin . '</p><br>';
        }
