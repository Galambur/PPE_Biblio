        ...
        foreach ($authors as $author) {
            ...
            <div class="eachAuthor">
                <p>(id:<?= $author->id_auteur ?>) <a
                    ...
                    if (isAdmin($id_client)){
                    ?>
                    <a href="../../admin/gestion_auteur/modifier_auteur.php?id_auteur=<?= $author->id_auteur ?>">Modifier</a>
                    ou
                    <a href="../../admin/gestion_auteur/supprimer_auteur.php?id_auteur=<?= $author->id_auteur ?>">Supprimer</a>
                    cet auteur</p>
                <?php
                }
                ?>
